...
<script>
    ...
    <div id="indexContainer" class="main-wrapper content content--mobile">
      ...
      <div class="tgd__top">
        ...
        <h2>TrueGameData</h2>
        <p>Stats for MW, BO:CW, VG, and WZ1 were hand tested at 240 FPS. Stats for MWII were sourced from Sym.gg. TrueGameData gives you access to advanced data visualization tools to help you build better loadouts and win more games.</p>
        ...
        <div class="tgd__top--subcontainer">
          ...
          <div class="button--gold--new" onclick="changeGameType('mw2')">
            MODERN WARFARE II
          </div>
      ...
      <div class="relative">
        <div class="tgd__absolute">
          ...
          <a class="button--gold--new"  href="./share_builder">
            MWII TUNING SHARE TOOL
          </a>
