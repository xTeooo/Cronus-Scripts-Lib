// Taylor's Polar Aim Assist {[ SHAPES ]}
/* Credits = TaylorDrift21  - DoNotAtMe { AKA[ME.] or [Dam]} */
...
/* C h o o s e  T r i g g e r s */

define Fire = PS4_R2;
define Ads  = PS4_L2;

/*======= T o g g l e  T a y l o r  A A ========*/

int ToggleTaylorPolarAim = TRUE;

/*======= C h a n g e  T h e  A A  C u r v e ======*/
...
/*=== S h a p e  I D |Z| P o l a r  C u r v e |Z| S q u a r e  C u r v e === 
             0                 Circular                  Diamond 
...
/*====== B o o s t  O n  F i r e  U s i n g  R u m b l e ======*/
...
int PolarStrength,SmartAAV1Rumble,SpiralPosition1,InnerSpiral,OuterSpiral,SpiralPosition2,Position,AngleDirection;
define False              = FALSE;
define True               = TRUE; 
...
main { 
	...
	{   
        ...
        // Speed On Movement of Right Stick Change \\ 
