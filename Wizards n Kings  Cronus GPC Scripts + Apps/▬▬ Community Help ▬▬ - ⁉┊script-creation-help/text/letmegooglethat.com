...
<body>
  ...
  <center>
    ...
    <br />
    <form id="search-form">
      <input id="search-input" class='text' size="55" autocorrect="off" spellcheck="false" autocapitalize="off" autocomplete="off"
        title="Google Search" type="text" value='' />
      </br>
      </br>
  ...
  <div id='about' style='display: none'>
    <p rel='localize[pitch]'>"Let me Google that" is for all those people that find it more convenient to bother you
      with their questions than to Google it for themselves ;)</p>
    <p rel='localize[credit]'></p>
    <p rel='localize[translated_by]'></p>
    <p rel='localize[disclaimer]'>
